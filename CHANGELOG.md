...
- Speed up the macOS E2E workflow by caching CocoaPods and compiling pods through ccache. ([#349](https://github.com/expo/orbit/pull/349) by [@gabrieldonadel](https://github.com/gabrieldonadel))

## 2.7.0 — 2026-06-14

### 🎉 New features

- Add support for DeviceHub.app on Xcode 27, which replaces Simulator.app. ([#343](https://github.com/expo/orbit/pull/343) by [@GersonRocha9](https://github.com/GersonRocha9))
...
- Update Orbit app and menu bar icons. ([#299](https://github.com/expo/orbit/pull/299) by [@gabrieldonadel](https://github.com/gabrieldonadel))
