...
export enum AppObserveEventsOrderByDirection {
  Asc = 'ASC',
  Desc = 'DESC'
}

export enum AppObserveEventsOrderByField {
...
export enum AppProfileImageWidth {
...
export enum EchoProjectUploadSessionType {
...
export enum UpdateDiffReceiptOrderByDirection {
  Asc = 'ASC',
  Desc = 'DESC'
}

export enum UpdateDiffReceiptOrderByField {
  CreatedAt = 'CREATED_AT',
  State = 'STATE'
}

export enum UpdateDiffReceiptStateValue {
  Failure = 'FAILURE',
  InProgress = 'IN_PROGRESS',
  Queued = 'QUEUED',
  Success = 'SUCCESS',
...
export enum WorkflowsInsightsExportFormat {
  Csv = 'CSV',
  Ndjson = 'NDJSON'
}
...
export type AppForPinnedListFragment = { __typename?: 'App', id: string, name: string, slug: string, latestActivity: any, profileImageUrl?: string | null, ownerAccount: { __typename?: 'Account', name: string } };
...
export type GetCurrentUserQuery = { __typename?: 'RootQuery', meUserActor?: { __typename?: 'SSOUser', id: string, username: string, firstName?: string | null, lastName?: string | null, bestContactEmail?: string | null, primaryAccountProfileImageUrl: string } | { __typename?: 'User', id: string, username: string, firstName?: string | null, lastName?: string | null, bestContactEmail?: string | null, primaryAccountProfileImageUrl: string } | null };
...
export const GetAppsForPinnedListDocument = gql`
  ...
  meUserActor {
    ...
    ${AppForPinnedListFragmentDoc}`;

/**
 * __useGetAppsForPinnedListQuery__
 *
 * To run a query within a React component, call `useGetAppsForPinnedListQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetAppsForPinnedListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetAppsForPinnedListQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetAppsForPinnedListQuery(baseOptions?: Apollo.QueryHookOptions<GetAppsForPinnedListQuery, GetAppsForPinnedListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAppsForPinnedListQuery, GetAppsForPinnedListQueryVariables>(GetAppsForPinnedListDocument, options);
      }
export function useGetAppsForPinnedListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAppsForPinnedListQuery, GetAppsForPinnedListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAppsForPinnedListQuery, GetAppsForPinnedListQueryVariables>(GetAppsForPinnedListDocument, options);
        }
