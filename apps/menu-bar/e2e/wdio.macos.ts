  ...
  capabilities: [
    {
      ...
      // Skip the local HTTP server in the app so macOS doesn't pop the
      // "find devices on local networks" TCC prompt during the test run —
      // see AppDelegate.applicationDidFinishLaunching.
      'appium:environment': { EXPO_ORBIT_E2E: '1' },
      ...appCap,
